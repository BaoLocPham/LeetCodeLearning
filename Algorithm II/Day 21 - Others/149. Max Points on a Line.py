class Solution:
    def maxPoints(self, points: List[List[int]]) -> int:
        ...
        def max_points_on_a_line_containing_point_i(i):
            # Compute max number of points on a line containing point i.
            def slope_coprime(x1, y1, x2, y2):
                # avoid the precision issues with the float/double number, using pair of co-prime numbers to represent the slope
            ...
            def add_line(i, j, count, duplicates):
                ...
                #
                # rewritee points as coordinates
                x1, y1 = points[i]
                x2, y2 = points[j]
                ...
                # only slope is needed for hash map
